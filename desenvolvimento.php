...
<head>
        ...
        <!-- Title -->
        <title> Desenvolvimento Social - PriMAX - Gestao & Tecnologica</title>
    ...
    <div class="inner-banner inner-bg1" style="background: url('images/inner-banner12.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="inner-title" style="text-align: center; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h3 style="margin: 0;">Desenvolvimento Social</h3>
                </div>
                <ul class="menu" style="margin: 0;">
                    <li>
                        <a href="index.php">Home</a>
                    </li>
                    <li><span class="contact-menu">Desenvolvimento Social</span></li>
                </ul>
            </div>
        </div>
      </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="banner-content-two">
                                    ...
                                    <p>Desenvolvimento social refere-se ao progresso e melhoria das condições sociais, econômicas e culturais de uma comunidade, sociedade ou país como um todo. Envolve a promoção do bem-estar, a redução da desigualdade, o fortalecimento das relações sociais e o aumento da qualidade de vida das pessoas.</p>          
                                </div>
                            </div>
         ...
         <div class="services-area-two pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2>Módulo de Desenvolvimento Social</h2>
                </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="services-tab-content pl-20">
                                                <h2>Educação</h2>
                                                <p>
                                                    Nosso objetivo é assegurar o acesso universal a uma educação de qualidade, desde a primeira infância até o ensino superior, visando a igualdade de oportunidades e capacitando indivíduos com as habilidades necessárias para uma vida produtiva e bem-sucedida.
                                                </p>
                                                <ul class="services-tab-list">
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Educação corporativa</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Desenvolvimento profissional</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'> workshops</i></li>
                                                </ul>
                                            </div>
