...
<head>
        ...
        <!-- Title -->
        <title> Controle interno - PriMAX - Gestao & Tecnologica</title>
    ...
    <div class="inner-banner inner-bg1" style="background: url('images/inner-banner12.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="inner-title" style="text-align: center; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h3 style="margin: 0;">Controle interno</h3>
                </div>
                <ul class="menu" style="margin: 0;">
                    <li>
                        <a href="index.php">Home</a>
                    </li>
                    <li><span class="contact-menu">Controle interno</span></li>
                </ul>
            </div>
        </div>
      </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="banner-content-two">
                                    ...
                                    <p>Controle interno é um conjunto de políticas, procedimentos e práticas adotadas por uma organização para garantir a eficiência operacional, a confiabilidade dos relatórios financeiros e o cumprimento das leis e regulamentos aplicáveis.</p>          
                                </div>
                            </div>
         ...
         <div class="services-area-two pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2>Módulo de Controle interno</h2>
                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-lg-6">
                                            <div class="services-tab-img">
                                                <a href="index.php"><img src="assets/images/services/services-large13.jpg" alt="Images"></a>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="services-tab-content pl-20">
                                                ...
                                                <p>
                                                    ...
                                                    Implementamos sistemas de controle interno de alta qualidade e eficiência, fornecendo às empresas a confiança necessária para proteger seus ativos, mitigar riscos e promover a integridade operacional.

                                                <p>
                    
                                               <ul class="services-tab-list">
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Estrutura de controle interno</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Avaliação de riscos</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i>
                                                    Monitoramento contínuo</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i>
                                                    Papel da alta administração</li>
                                                </ul>
