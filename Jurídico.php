...
<head>
        ...
        <!-- Title -->
        <title> Jurídico - PriMAX - Gestao & Tecnologica</title>
    ...
    <div class="inner-banner inner-bg1" style="background: url('images/inner-banner12.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover;">
        <div class="container">
            <div class="inner-title" style="text-align: center; display: flex; justify-content: space-between; align-items: center;">
                <div>
                    <h3 style="margin: 0;">Jurídico</h3>
                </div>
                <ul class="menu" style="margin: 0;">
                    <li>
                        <a href="index.php">Home</a>
                    </li>
                    <li><span class="contact-menu">Jurídico</span></li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="banner-content-two">
                                    <h1>Jurídico</h1>
                                    <p>Fornecer orientações e pareceres legais para a empresa, ajudando a identificar possíveis riscos e soluções para questões jurídicas em diversas áreas, como contratos, regulamentações, compliance, propriedade intelectual, direito do trabalho, direito comercial, entre outros.. </p>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="services-tab-content pl-20">
                                                <h2>Jurídico</h2>
                                                <p>
                                                    O sistema gerencia e controla de forma eficiente todas as etapas dos processos judiciais, garantindo o cumprimento dos prazos estabelecidos pelos Tribunais Estaduais e Federais. Através de integração via Webservice, são enviados alertas que evitam a perda de prazos processuais.
                                                </p>
                    
                                                <ul class="services-tab-list">
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Utilização de tecnologia de inteligência artificial e aprendizado de máquina para análise de dados jurídico, pesquisa jurisprudencial e detecção de padrões.</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Automação de processos jurídicos, elaboração de petições e gestão de documentos.</li>
                                                    <li><i class='flaticon-arrow-pointing-to-right'></i> Utilização de ferramentas de análise e relatórios jurídicos para auxiliar na tomada de decisões estratégicas.</li>
                                ...
                                <div class="tabs_item">
                                    ...
                                    <div class="tabs_item">
                                        <div class="row align-items-center">
                                            <div class="col-lg-6">
                                                <div class="services-tab-img">
                                                    <a href="service-details.php"><img src="assets/images/services/services-large25.jpg" alt="Images"></a>
                                                </div>
                                            </div>
