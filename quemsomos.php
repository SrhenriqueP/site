...
<head>
    ...
    <!-- Title -->
    <title> Quem Somos - PriMAX - Gestao & Tecnologica</title>
        ...
        <div class="inner-banner inner-bg1" style="background: url('images/inner-banner12.jpg'); background-position: center; background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="inner-title" style="text-align: center; display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <h3 style="margin: 0;">Quem Somos</h3>
                    </div>
                    <ul class="menu" style="margin: 0;">
                        ...
                        <li><span class="contact-menu">Quem Somos</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center justify-align-center">
                    <div class="col-lg-6">
                        <div class="banner-content">
                            <h1 class="wow animate__animated animate__fadeInDown" data-wow-delay="00ms" data-wow-duration="1000ms">Quem Somos</h1>

                            <p class="wow animate__animated animate__fadeInUp" data-wow-delay="100ms" data-wow-duration="1000ms">Somos uma empresa que atua no mercado tecnológico, reconhecidos por nossa proatividade e competitividade. Com uma sólida expertise em gestão tecnológica, estamos na vanguarda da inovação, impulsionando o crescimento e a transformação digital tanto para nossos clientes como para as empresas parceiras.</p>
                    ...
                    <div class="col-lg-6 pe-0">
                        <div class="banner-img-three wow animate__animated animate__fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms" data-speed="0.08">
                            <img src="assets/images/home-three/home-three-01.jpg" alt="Banner Images">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="about-area about-mt">
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="assets/images/about-img/about-img14_resized.jpg" alt="About Images">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content pl-20">
                            <div class="section-title">
                                <span class="sp-title">Quem Somos</span>
                                <h2>Criando o futuro da tecnologia por 13 anos em nossa gestão!</h2>
                                <p>
                                    Fundada em 2010, a PriMax é uma empresa líder em soluções empresariais, impulsionada pela inovação e tecnologia avançada. Com expertise em gestão, arrecadação, controle interno, desenvolvimento social, BI (inteligência em negócios), ouvidoria, fiscal e jurídico, também incorporamos a inteligência artificial (IA) em nossos sistemas.

                                    Nossos sistemas são projetados para proporcionar uma experiência ainda mais ágil e eficaz aos nossos clientes. Através da inteligência artificial, somos capazes de processar grandes volumes de dados em tempo real, fornecendo respostas precisas e insights estratégicos. Isso permite uma tomada de decisão informada e eficiente, impulsionando o sucesso dos nossos clientes.

                                    Na PriMax, estamos comprometidos em oferecer soluções inovadoras e tecnologicamente avançadas, tornando nossos serviços cada vez mais eficientes e adaptados às necessidades do mercado. Acreditamos que a combinação de expertise e inteligência artificial nos coloca na vanguarda da transformação digital, trazendo resultados excepcionais para nossos clientes.

                                </p>
                            </div>

                            <ul class="about-list">
                                <li><i class='flaticon-arrow-pointing-to-right'></i> Governança de TI e alinhamento estratégico</li>
                                <li><i class='flaticon-arrow-pointing-to-right'></i> Estratégia de inovação e incorporação de novas tecnologias</li>
                                <li><i class='flaticon-arrow-pointing-to-right'></i> Análise de dados e inteligência de negócios</li>
                                <li><i class='flaticon-arrow-pointing-to-right'></i> Cultura organizacional e capacitação em tecnologia</li>
                            </ul>
        ...
        <div class="project-area pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    <span class="sp-title">Inovação</span>
                    <p>Nossa visão sempre foi criar um serviço totalmente revolucionário, envolvendo as pessoas em uma experiência imersiva e inteligente. A PriMAX transforma essa visão em realidade, oferecendo soluções inovadoras que proporcionam agilidade e eficiência em todas as interações. Com um serviço único e de última geração, a PriMAX está na vanguarda do mercado, atendendo às necessidades das pessoas de forma rápida e intuitiva.
                    </p>
                </div>

                <div class="project-slider owl-carousel owl-theme pt-45">
                    <div class="project-item">
                            <img src="assets/images/projects/project-img11.jpg" alt="Project Images">
                        </a>
                        <div class="content">
                            <h3><a>Colaboradores</a></h3>
                            <p>Colaboradores com alto grau de conhecimento na área de TI.</p>
                        </div>
                    </div>

                    <div class="project-item">
         
                            <img src="assets/images/projects/project-img12.jpg" alt="Project Images">
                        </a>
                        <div class="content">
                            <h3><a>Fornecedores</a></h3>
                            <p>Fornecedores e parceiros líderes de mercado brasileiro.</p>
                        </div>
                    </div>

                    <div class="project-item">
                            <img src="assets/images/projects/project-img13.jpg" alt="Project Images">
                        </a>
                        <div class="content">
                            <h3><a>Inovação</a></h3>
                            <p>Nós investimos em tecnologia de alta qualidade e eficiência.</p>
                        </div>
                    </div>

                    <div class="project-item">
                            <img src="assets/images/projects/project-img14.jpg" alt="Project Images">
                        </a>
                        <div class="content">
                            <h3><a> Qualidade</a></h3>
                            <p>Área dedicada a qualidade do serviço ISO 9004.</p>
                        </div>
                    </div>
